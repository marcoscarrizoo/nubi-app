        ...
        <View>
          <TouchableHighlight onPress={resType}>
            <MaterialCommunityIcons
              ...
              size={30}
            >
              <Text style={styles.text}>{responseFromApi[0].name}</Text>
            </MaterialCommunityIcons>
          </TouchableHighlight>
            ...
            <View style={{ marginLeft: 40 }}>
              <TouchableHighlight onPress={resFile}>
                <MaterialCommunityIcons
                  ...
                  size={30}
                >
                  <Text style={styles.text}>{responseFromApi[0].type}</Text>
                </MaterialCommunityIcons>
              </TouchableHighlight>
            </View>
          ) : (
          ...
          <TouchableHighlight onPress={resType1}>
            <MaterialCommunityIcons
              ...
              size={30}
            >
              <Text style={styles.text}>{responseFromApi[1].name}</Text>
            </MaterialCommunityIcons>
          </TouchableHighlight>
        </View>
      ) : (
        ...
        <View style={{ marginLeft: 30 }}>
          <TouchableHighlight onPress={resFile1}>
            <MaterialCommunityIcons
              ...
              size={30}
            >
              <Text style={styles.text}>{responseFromApi[1].type}</Text>
            </MaterialCommunityIcons>
          </TouchableHighlight>
        </View>
      ) : (
